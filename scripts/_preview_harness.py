    ...
    return DataProduct(
        ...
        entities=[
            ...
            EntityMetadata(
                ...
                database_name="CallCentre_PRE_STD_T",
                table_name="call_behaviour_features",
        ...
        relationships=[
            ...
            TableRelationship(
                relationship_id=3,
                source_database="CallCentre_PRE_STD_T",
                source_table="call_behaviour_features",
                source_column="call_id",
                target_database=DOM,
                target_table="Call_H",
                target_column="call_id",
            ...
            TableRelationship(
                ...
                source_column="call_id",
                target_database="CallCentre_PRE_STD_T",
                target_table="call_behaviour_features",
                target_column="call_id",
                relationship_type="FK",
                cardinality="N:1",
        ...
        data_lineage=[
            DataLineage(
                ...
                target_table="Call_H",
                source_table="stg_call",
                source_database="CallCentre_STG_STD_T",
                job_name="load_call",
        ...
        view_metadata=[
            ViewMetadata(
                ...
                view_name="Call_H",
                view_type="LOCKING",
                view_purpose="1:1 locking view over Call_H",
                is_primary=1,
            ),
            ViewMetadata(
                view_metadata_id=2,
                ...
                view_type="CURRENT",
                view_purpose="Current-version view over Call_H",
            ),
            ViewMetadata(
                view_metadata_id=3,
                base_database="CallCentre_DOM_STD_T",
                ...
                view_type="ENRICHED",
                view_purpose="Enriched call view",
            ),
            ViewMetadata(
                view_metadata_id=4,
                base_database="CallCentre_DOM_STD_T",
                ...
                view_name="Agent_H",
                view_type="LOCKING",
                view_purpose="1:1 locking view over Agent_H",
                is_primary=1,
            ),
            ViewMetadata(
                view_metadata_id=5,
                ...
                base_table="Agent_H",
                view_database="CallCentre_DOM_BUS_V",
                view_name="Agent_Current",
                view_type="CURRENT",
                view_purpose="Current-version view over Agent_H",
            ),
            ViewMetadata(
                view_metadata_id=6,
                base_database="CallCentre_DOM_STD_T",
                base_table="Call_Score_H",
                view_database="CallCentre_DOM_STD_V",
                view_name="Call_Score_H",
                view_type="LOCKING",
                view_purpose="1:1 locking view over Call_Score_H",
                is_primary=1,
            ),
            ViewMetadata(
                view_metadata_id=7,
                ...
                base_table="Call_Score_H",
                view_database="CallCentre_DOM_BUS_V",
                view_name="Call_Score_Current",
                view_type="CURRENT",
                view_purpose="Current-version view over Call_Score_H",
            ),
            ViewMetadata(
                view_metadata_id=8,
                base_database="CallCentre_DOM_STD_T",
                base_table="Call_Summary_H",
                view_database="CallCentre_DOM_STD_V",
                view_name="Call_Summary_H",
                view_type="LOCKING",
                view_purpose="1:1 locking view over Call_Summary_H",
                is_primary=1,
            ),
            ViewMetadata(
                view_metadata_id=9,
                base_database="CallCentre_DOM_STD_T",
                base_table="Call_Topic_H",
                view_database="CallCentre_DOM_STD_V",
                view_name="Call_Topic_H",
                view_type="LOCKING",
                view_purpose="1:1 locking view over Call_Topic_H",
                is_primary=1,
            ),
            ViewMetadata(
                view_metadata_id=10,
                base_database="CallCentre_PRE_STD_T",
                base_table="call_behaviour_features",
                view_database="CallCentre_PRE_STD_V",
                view_name="call_behaviour_features",
                view_type="LOCKING",
                view_purpose="1:1 locking view over call_behaviour_features",
                is_primary=1,
            ),
            ViewMetadata(
                view_metadata_id=11,
                base_database="CallCentre_PRE_STD_T",
                base_table="call_behaviour_features",
                view_database="CallCentre_PRE_BUS_V",
                view_name="call_features_current",
                view_type="CURRENT",
                view_purpose="Current feature rows",
            ),
            ViewMetadata(
                view_metadata_id=12,
                base_database="CallCentre_PRE_STD_T",
                base_table="call_behaviour_features",
                view_database="CallCentre_PRE_BUS_V",
                view_name="call_features_enriched",
                view_type="ENRICHED",
                view_purpose="Features enriched with call attributes",
            ),
            ViewMetadata(
                view_metadata_id=13,
                base_database="CallCentre_PRE_STD_T",
                base_table="call_behaviour_features",
                view_database="CallCentre_PRE_BUS_V",
                view_name="call_features_pit",
                view_type="PIT",
                view_purpose="Point-in-time feature view",
            ),
            ViewMetadata(
                view_metadata_id=14,
                base_database="CallCentre_PRE_STD_T",
                base_table="model_prediction",
                view_database="CallCentre_PRE_STD_V",
                view_name="model_prediction",
                view_type="LOCKING",
                view_purpose="1:1 locking view over model_prediction",
                is_primary=1,
            ),
        ],
        lineage_run=[
