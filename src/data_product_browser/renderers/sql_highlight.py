...
_KEYWORDS = frozenset(
    ...
    INITIATE RESTART RELEASE LOCK CHECKPOINT FLUSH NAMED
    TABLE VIEW INDEX MACRO PROCEDURE FUNCTION TRIGGER TYPE SEQUENCE
    ...
    MULTISET VOLATILE GLOBAL VIRTUAL VARYING MATERIALIZED
    ...
    CHECKSUM MERGEBLOCKRATIO DATABLOCKSIZE LOG ANSI BLOCKCOMPRESSION
    COMPRESS DECOMPRESS ALGORITHM
    GENERATED ALWAYS IDENTITY START INCREMENT MINVALUE MAXVALUE
    PRESERVE COMMITTED COLUMN PARTITIONED MULTILEVEL CONDITIONAL ASYNC
    PERIODICAL
